/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareBindings` (hash: d60341a26ac6c4f61694aba44b3b2b9a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "NODE_ENV" | "PSTBN_URL" | "CLOUDFLARE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ZONE_ID" | "CLOUDFLARE_CACHE_DOMAIN" | "COMMIT_SHA" | "VITE_DEVTOOLS" | "VITE_LOG_LEVEL" | "VITE_FORWARD_CONSOLE" | "VITE_ENABLE_INSPECT" | "UNKEY_ROOT_KEY" | "UNKEY_WORKSPACE_ID" | "UNKEY_WORKSPACE_NAME" | "UNKEY_KEY_SECRET">> {}
}
