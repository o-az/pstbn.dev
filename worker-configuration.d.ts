/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareBindings` (hash: c9354f19d9bc679a49a425b843dac83d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "NODE_ENV" | "PSTBN_URL" | "PSTBN_API_KEY" | "COMMIT_SHA" | "VITE_DEVTOOLS" | "VITE_LOG_LEVEL" | "VITE_FORWARD_CONSOLE" | "VITE_ENABLE_INSPECT" | "UNKEY_ROOT_KEY" | "UNKEY_WORKSPACE_ID" | "UNKEY_WORKSPACE_NAME" | "UNKEY_KEY_SECRET">> {}
}
