/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareBindings` (hash: 8ddce4b2653ad725eea26d6945aeea21)
// Runtime types generated with workerd@1.20260710.1 2026-03-17 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	PASTE_METADATA: KVNamespace;
	PASTE_CONTENT: R2Bucket;
	RATE_LIMIT_FREE: RateLimit;
	RATE_LIMIT_KEYED: RateLimit;
	PORT: string;
	NODE_ENV: string;
	...
	UNKEY_WORKSPACE_ID: string;
	UNKEY_WORKSPACE_NAME: string;
	UNKEY_KEY_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "NODE_ENV" | "CLOUDFLARE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ZONE_ID" | "CLOUDFLARE_CACHE_DOMAIN" | "PSTBN_URL" | "PSTBN_API_KEY" | "COMMIT_SHA" | "VITE_DEVTOOLS" | "VITE_LOG_LEVEL" | "VITE_FORWARD_CONSOLE" | "VITE_ENABLE_INSPECT" | "UNKEY_ROOT_KEY" | "UNKEY_WORKSPACE_ID" | "UNKEY_WORKSPACE_NAME" | "UNKEY_KEY_SECRET">> {}
}
